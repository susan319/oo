...
<div class="x-body layui-anim" id="app">
    ...
    <form class="layui-form form-container" action="/other/posts/calculation" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="attendance_days"  required="" lay-verify="required" placeholder="请输入考勤天数" class="layui-input" value="{{$other->attendance_days or 0}}">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="hydropower" required="" lay-verify="required" placeholder="请输入水电费" class="layui-input" value="{{$other->hydropower or 0}}">
            </div>
...
<script>
    var remarks = {!!$other->remarks_money or "'null'" !!};
     if (remarks == 'null') {
        remarks = [];
     }
