...
<html>
  ...
  <body>
    ...
    <div class="x-body layui-anim layui-anim-up">
        <form class="layui-form form-container" action="/dormitory_management/apartment/add" method="post">
                      ...
                      <div class="layui-input-inline">
                        <select name="pid" lay-verify="required" lay-filter="select" >
                            ...
                            @foreach($apartments as $apartment)
                                <option value="{{$apartment->id}}" title="{{$apartment->level}}">{{$apartment->name}}</option>
                            @endforeach
                        </select>
                      </div>
                      <div class="layui-form-mid layui-word-aux">顶级表示是公寓</div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="name" value="" required="" lay-verify="required" placeholder="请输入公寓&房间号" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="resident_number" value=""  placeholder="请输入可住人数" class="layui-input">
                    </div>
                </div>
